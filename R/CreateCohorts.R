...
#
# This file is part of traliDiagnosticsPackage
#
...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "traliDiagnosticsPackage",
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "traliDiagnosticsPackage")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "traliDiagnosticsPackage")
